...
def render_enhanced_sidebar():
    ...
    with st.sidebar:
        ...
        tabs_info = [
            ...
            ("📐", TXT("هندسة الصراط", "Path Geometry"), TXT("تتبع مسارك", "Track your path")),
            ("📜", TXT("الشواهد", "Evidence"), TXT("مقارنة التاريخ", "Compare history")),
            ("🌍", TXT("المرصد الأخلاقي", "Moral Observatory"), TXT("خريطة العالم", "World map")),
            ...
            ("🔄", TXT("دورة الصلاة", "Prayer Cycle"), TXT("محطات الاستعانة", "Stations of seeking help")),
            ("⚡", TXT("الطاقة الروحية", "Spiritual Energy"), TXT("قوانين الطاقة", "Energy laws")),
            ("📖", TXT("المعجم الهندسي", "Geometric Lexicon"), TXT("أسرار الحروف", "Letter secrets")),
            ("📚", TXT("الدليل المرجعي", "Reference Guide"), TXT("المراجع والمعجم", "References & lexicon")),
        ]
