...
def render_welcome():
    ...
    # ─────────────────────────────────────────
    # ٣. أقسام المنصة – خريطة الطريق
    # ─────────────────────────────────────────
    st.markdown("---")
    st.subheader(TXT("🧭 أقسام المنصة – خارطة طريقك", "🧭 Platform Sections – Your Roadmap"))
    st.caption(TXT(
        "هذه هي الأبواب التي ستلج منها إلى فهم القانون. كل باب يخدم غرضاً، وكل محطة تقربك خطوة من النور.",
        "These are the gates through which you will enter to understand the law. Each serves a purpose, each brings you a step closer to the light."
    ))
    
    tabs_info = [
        ("🧍", TXT("البوصلة", "Compass"), TXT("اكتشف موقعك الآن", "Discover your position now")),
        ("🏛️", TXT("مختبر الأمة", "Nation Lab"), TXT("حلل دولة أو مجتمعاً", "Analyze a nation or community")),
        ("🌌", TXT("المشهد الكوني", "Cosmic Scene"), TXT("شاهد تفاعل الأفراد", "Watch individuals interact")),
        ("🧬", TXT("محاكي المجتمع", "Social Fabric"), TXT("النسيج الاجتماعي الحي", "The living social fabric")),
        ("🌍", TXT("المرصد العالمي", "Observatory"), TXT("خريطة العالم بالميزان", "World map with the balance")),
        ("🩺", TXT("طبيب القلوب", "Healer"), TXT("تشخيص وروشتة", "Diagnosis & prescription")),
        ("🤝", TXT("شبكة الناجين", "Network"), TXT("تواصل مع الثابتين", "Connect with the steadfast")),
        ("🎓", TXT("الجامعة", "Academy"), TXT("تعلم النظرية", "Learn the theory")),
        ("🏴", TXT("آل البيت", "Ahlul Bayt"), TXT("نماذج الثبات", "Models of stability")),
        ("📐", TXT("هندسة الصراط", "Path Geometry"), TXT("تتبع مسارك", "Trace your path")),
        ("📚", TXT("الدليل المرجعي", "Reference"), TXT("المراجع والمعجم", "References & lexicon")),
    ]
    ...
    st.markdown(TXT(
        ...
        أنت لم تصل إلى هنا صدفة. فطرتك قادتك، وعقلك أرشدك، وقلبك حنّ إلى الحقيقة.
        
        هذا المختبر ليس سوى أداة، لعله يفتح لك باباً. والباب إذا فُتح، فالطريق أمامك. والطريق هو الصراط المستقيم.
        
        **فهل أنت مستعد لتخطو الخطوة الأولى؟**
        ...
        **S = W × B**
        ...
        You did not arrive here by chance. Your innate nature led you, your intellect guided you, and your heart longed for the truth.
        
        This lab is but a tool, perhaps it opens a door for you. And if the door opens, the path is before you. And the path is the straight path.
