...
<style>
    ...
    .sub-title { font-size: 1em; color: #CCCCCC; text-align: center; margin: 0 0 5px 0; }
    .author-line { font-size: 0.9em; color: #FFD700; text-align: center; margin-bottom: 20px; }
    .stButton > button {
        border-radius: 10px; font-weight: bold; height: 2.6em;
        background: linear-gradient(180deg, #1a1a3e 0%, #0d0d28 100%);
        color: #FFD700; border: 1.5px solid #DAA520; transition: all 0.3s;
    }
    ...
    [data-testid="stExpander"] details {
        background: rgba(10,10,40,0.6); border: 1px solid rgba(218,165,32,0.4);
...
st.markdown('<p class="author-line">© 2026 Ali Adel Alatifi | جميع الحقوق محفوظة</p>', unsafe_allow_html=True)

# =============================================
# 📜 رسالة الترحيب والتعريفات (قابلة للطي)
# =============================================
with st.expander("📜 رسالة الترحيب والتعريفات", expanded=False):
    ...
    with tab1:
        ...
        وهو القيم لأنه من القيوم نفسه. هو القانون الأعظم.
...
# =============================================
# 🎛️ الشريط الجانبي – جميع الخيارات (مضمونة)
# =============================================
with st.sidebar:
...
st.markdown("---")
st.markdown("<p style='text-align:center;color:gray;font-size:0.8em;'>© 2026 Ali Adel Alatifi | Al-Deen Al-Qayyim – The Cosmic Balance Law | V30</p>", unsafe_allow_html=True)
