...
# =============================================
# 🧭 تبويب البوصلة الكونية (12 سؤالاً – نظام العدد 12)
# =============================================
with tab2:
    st.header("🧭 البوصلة الكونية")
    st.subheader("اختبار الإحداثيات الوجودية – اكتشف موقعك في فضاء الولاء والبراء")
    st.caption("6 أسئلة للولاء + 6 أسئلة للبراء = 12 سؤالاً | أقصى درجة = 36 | S = L × D")
    ...
    questions = {
        "L": [
            {"id": "L1", "q": "الشهادتان (أ = 1): أصل الولاء لله ورسوله، والإخلاص لهما. هل هما محور حياتك؟", "a": [("هما أساس وجودي وأجاهد لتحقيق مقتضاهما (3)", 3), ("أنطق بهما وأؤمن بمعناهما لكني مقصر (1)", 1), ("أرددهما دون فهم أو عمل (0)", 0), ("أشك في مدلولهما أو أعرض عنهما (-1)", -1)]},
            {"id": "L2", "q": "الصلاة (ل = 30): صلة يومية بالله، عماد الدين وإخلاص العبادة. كيف هي صلاتك؟", "a": [("أقيمها بخشوع في وقتها وكأني أرى الله (3)", 3), ("أصلي الفروض غالباً مع شيء من التكاسل (1)", 1), ("أصلي بعضها وأقطع بعضها (0)", 0), ("لا أصلي أو أقطعها بالكلية (-1)", -1)]},
            {"id": "L3", "q": "الزكاة (ك = 20): تطهير للمال وتزكية للنفس، والإخلاص فيها لله. كيف حالك معها؟", "a": [("أخرجها كاملة طيبة بها نفسي ابتغاء وجه الله (3)", 3), ("أخرجها لكني أتثاقل أو أنفق في غير وجهه (1)", 1), ("أخرج شيئاً يسيراً دون حساب (0)", 0), ("لا أخرجها أو أمتنع عن أدائها (-1)", -1)]},
            {"id": "L4", "q": "الصوم (م = 40): تدريب على التقوى والإخلاص لله في السر والعلن. كيف هو صومك؟", "a": [("أصوم الفرض والنفل وأجاهد نفسي على الإخلاص فيه (3)", 3), ("أصوم الفرض غالباً لكني أقع في اللغو (1)", 1), ("أصوم بعض الفرض وأفطر بعضه (0)", 0), ("لا أصوم أو أفطر عمداً بلا عذر (-1)", -1)]},
            {"id": "L5", "q": "الحج (ه = 5): قصد بيت الله وإجابة ندائه بإخلاص. هل تعقد العزم على أدائه؟", "a": [("أديت الفريضة أو أسعى جاهداً مخلصاً لأدائها (3)", 3), ("أتمنى أداءها لكني لم أعزم أو أخطط (1)", 1), ("أراه واجباً لكني مشغول بدنياي (0)", 0), ("لا أهتم به أو أستهين بوجوبه (-1)", -1)]},
            {"id": "L6", "q": "الولاء للمؤمنين (ن = 50): الحب في الله، والنصرة، والإخلاص في معاملة الأمة. كيف هو حبك ونصرتك لإخوانك؟", "a": [("أحبهم في الله وأواسيهم وأنصرهم مخلصاً لله (3)", 3), ("أحبهم لكني لا أنصرهم إلا إذا لم يضرني (1)", 1), ("مشاعري نحوهم فاترة أو محايدة (0)", 0), ("أبغضهم أو أخذلهم أو أوالي أعداءهم (-1)", -1)]},
        ],
        "D": [
            {"id": "D1", "q": "الأمر بالمعروف (ف = 80): الدعوة إلى الله وإصلاح المجتمع ابتغاء وجهه. هل تأمر بالمعروف؟", "a": [("آمر به بلساني وحالي مخلصاً لله (3)", 3), ("آمر به أحياناً إذا لم أتعرض لضرر (1)", 1), ("أكتفي بفعله دون أمر غيري (0)", 0), ("لا آمر به أو أنهى عنه (-1)", -1)]},
            {"id": "D2", "q": "النهي عن المنكر (ش = 300): الغيرة على محارم الله وإنكار الباطل. هل تنهى عن المنكر؟", "a": [("أنهى عنه بلساني ويدي حسب استطاعتي مخلصاً لله (3)", 3), ("أنكره بقلبي أو أنهى عنه إذا لم أخف ضرراً (1)", 1), ("أسكت عنه ولا أتدخل (0)", 0), ("أشارك فيه أو أقر المنكر (-1)", -1)]},
            {"id": "D3", "q": "الجهاد في سبيل الله (ظ = 900): ذروة سنام الإسلام، بذل النفس والمال لإعلاء كلمة الله. ما موقفك منه؟", "a": [("أعتقد وجوبه وأجاهد بكل أشكاله مخلصاً لله (3)", 3), ("أتمنى الجهاد لكني أعجز عنه الآن (1)", 1), ("أخافه أو أقدم غيره عليه (0)", 0), ("أرفضه أو أسخر منه أو أعين أعداء الدين (-1)", -1)]},
            {"id": "D4", "q": "البراءة من الشرك (ق = 100): المفاصلة التامة للشرك وأهله والتبري منهم أمام الله. هل أنت بريء من الشرك؟", "a": [("أتبرأ من كل شرك ظاهر وباطن ولا أوالي المشركين (3)", 3), ("أتبرأ من الشرك الظاهر لكني لا أهتم بالباطن (1)", 1), ("لا أهتم كثيراً بموضوع البراءة (0)", 0), ("أوالي المشركين أو أشاركهم شعائرهم (-1)", -1)]},
            {"id": "D5", "q": "البراءة من الكفر (غ = 1000): رفض الكفر وأهله وعدم موادتهم. ما موقفك من الكفر وأهله؟", "a": [("أبغض الكفر وأهله ولا أواليهم مخلصاً لله (3)", 3), ("أبغض الكفر لكني أتعامل مع أهله عادة (1)", 1), ("لا فرق عندي بين الكفر والإيمان (0)", 0), ("أحب الكفر أو أهله أو أنتصر لهم (-1)", -1)]},
            {"id": "D6", "q": "البراءة من النفاق (ض = 800): كره النفاق والتحذير منه ومن أهله. كيف تنظر للنفاق وأهله؟", "a": [("أمقته وأحذر منه وأجاهد نفسي على الإخلاص (3)", 3), ("أكرهه لكني قد أتلون في بعض المواقف (1)", 1), ("لا أهتم بموضوع النفاق (0)", 0), ("أرى النفاق ذكاء أو أسلوب حياة مقبول (-1)", -1)]},
        ]
    }

    st.markdown("### 📝 أجب عن الأسئلة التالية بصدق (12 سؤالاً متوازياً)")
    ...
    if len(st.session_state.compass_answers) == total_questions:
        ...
        with c2:
            ...
            <div style="background: rgba(10,10,46,0.8); border-radius: 15px; padding: 20px; border: 2px solid {q_colors[quadrant]}; margin: 10px 0; text-align: center;">
                ...
                <p style="font-size: 0.8em; color: #aaa;">الدرجة الخام: L = {L_score} / {max_score} | D = {D_score} / {max_score}</p>
