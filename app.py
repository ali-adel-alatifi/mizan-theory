...
# لا يجوز نسخ أو تعديل أو توزيع هذا الكود دون الإشارة إلى المؤلف الأصلي.
# =============================================
...
if st.session_state.run:
    ...
    while st.session_state.run:
        ...
        ax_cosmic.add_patch(Circle((24.5,4.0), 0.35+0.45*S, color='#00FF88', alpha=0.35, zorder=7, ec='#00FF88', lw=1))
...
st.markdown("---")
st.markdown("### ⚖️ S = W × B | الدِّينُ الْقَيِّم – قَانُونُ التَّوَازُنِ الْكَوْنِيّ")
st.markdown("*Ali Adel Alatifi | *")
