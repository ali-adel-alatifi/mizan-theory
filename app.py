...
st.set_page_config(page_title="الميزان", page_icon="⚖️", layout="wide", initial_sidebar_state="expanded")
...
st.markdown("""
<div style="text-align: center; background: linear-gradient(180deg, #000000 0%, #1a1a2e 100%); 
padding: 40px 20px; border-radius: 25px; border: 3px solid #FFD700; margin-bottom: 25px;
box-shadow: 0 0 60px rgba(255, 215, 0, 0.5), 0 0 120px rgba(255, 215, 0, 0.2);">
    <span style="font-size: 70px;">⚖️</span>
    <h1 style="color: #FFD700; font-size: 56px; margin: 15px 0; font-weight: 900; 
    letter-spacing: 6px; text-shadow: 0 0 25px rgba(255,215,0,0.8);">
        الميزان
    </h1>
    <span style="font-size: 70px;">⚖️</span>
    <p style="color: #FFD700; font-size: 22px; margin: 15px 0 5px 0; font-weight: bold;">علي عادل العاطفي</p>
    <p style="color: #FFD700; font-size: 14px; margin: 0; font-style: italic; opacity: 0.8;">Ali Adel Alatifi</p>
    <p style="color: #CCCCCC; font-size: 18px; margin: 15px 0 0 0; letter-spacing: 2px;">S = W × B | قانون التوازن الكوني</p>
</div>
""", unsafe_allow_html=True)

# ====================== رسالة الترحيب (الإطار الثاني) ======================
st.markdown("""
<div style="background: linear-gradient(180deg, #0a0a1a 0%, #1a1a2e 100%); 
padding: 35px 25px; border-radius: 20px; border: 2px solid #FFD700; margin-bottom: 25px;
box-shadow: 0 0 40px rgba(255, 215, 0, 0.3);">
    <h2 style="color: #FFD700; text-align: center; font-size: 24px; margin-bottom: 20px;">
        "هل يوجد قانون واحد يحكم الذرة والحضارة؟ هذا هو نموذج الميزان الذي يثبت أن S = W × B"
    </h2>
    <p style="color: #CCCCCC; text-align: center; font-size: 16px; margin-bottom: 25px;">
        محاكاة نظرية الميزان (S = W × B) – نموذج تفاعلي يحاكي صراع النور والظلام في الحضارات
    </p>
    <hr style="border-color: #FFD700; width: 50%; opacity: 0.4; margin: 20px auto;">
    <p style="color: #d0d0d0; text-align: center; font-size: 16px; line-height: 2.2; font-style: italic; margin-bottom: 25px;">
        "الدين القيم = قانون السببية الكوني، وهو الحق لأن واضعه الحق، وهو القيم لأنه من القيوم نفسه. 
        هو القانون الأعظم، إنه 'الدين القيم' الذي هو أصل الوجود وغايته. إنه القانون الذي أزال الله به العدم، 
        وأوجد به الخلق، وأجرى به السنن، وسيكون به الجزاء. إنه 'الميزان' الذي قامت به السماوات والأرض، 
        والذي يدور حوله كل شيء، من الأزل إلى الخلود."
    </p>
    <hr style="border-color: #FFD700; width: 50%; opacity: 0.4; margin: 20px auto;">
    <p style="color: #FFFFFF; text-align: center; font-size: 17px; line-height: 2.2; margin-bottom: 25px;">
        "أيها البشر، لستم في فوضى. هناك قانون. هناك نظام. هناك ميزان. استقراركم ليس صدفة. 
        انهياركم ليس حظاً سيئاً. إنها معادلة. إنها S = W × B."
    </p>
    <hr style="border-color: #FFD700; width: 50%; opacity: 0.4; margin: 20px auto;">
    <h3 style="color: #FFD700; text-align: center; font-size: 20px; margin-bottom: 15px;">📖 "الميزان" مصطلح قرآني كوني أصيل</h3>
    <table style="margin: 0 auto; color: #d0d0d0; font-size: 15px; border-collapse: collapse;">
        <tr><td style="padding: 8px 15px;">الرحمن 7</td><td style="padding: 8px 15px; color: #FFD700;">﴿وَالسَّمَاءَ رَفَعَهَا وَوَضَعَ الْمِيزَانَ﴾</td></tr>
        <tr><td style="padding: 8px 15px;">الحديد 25</td><td style="padding: 8px 15px; color: #FFD700;">﴿وَأَنزَلْنَا مَعَهُمُ الْكِتَابَ وَالْمِيزَانَ﴾</td></tr>
        <tr><td style="padding: 8px 15px;">الشورى 17</td><td style="padding: 8px 15px; color: #FFD700;">﴿اللَّهُ الَّذِي أَنزَلَ الْكِتَابَ بِالْحَقِّ وَالْمِيزَانَ﴾</td></tr>
    </table>
    <p style="color: #AAAAAA; text-align: center; font-size: 14px; margin-top: 15px;">
        "الميزان" في القرآن هو قانون التوازن الكوني الذي يحكم كل شيء. هذا هو بالضبط ما نريد إثباته.
    </p>
    <hr style="border-color: #FFD700; width: 50%; opacity: 0.4; margin: 20px auto;">
    <p style="color: #d0d0d0; text-align: center; font-size: 16px; line-height: 2.2;">
        المشهد المتكامل الذي يجمع كل شيء في آن واحد: من الذرة إلى المجرة، ومن الفيزياء إلى الأخلاق، 
        ومن الفرد إلى الحضارة – كله يسير بقانون واحد هو S = W × B. 🌌
    </p>
    <hr style="border-color: #FFD700; width: 50%; opacity: 0.4; margin: 20px auto;">
    <p style="color: #d0d0d0; text-align: center; font-size: 16px; line-height: 2.2;">
        الدين القيم = القانون الإلهي الذي يسري على كل شيء من الأزل إلى الخلود. 
        الإسلام = الاستجابة للقانون الإلهي من خلال توازن الولاء والبراءة، كل مخلوق بما يناسب فطرته = 
        الثبات والاستقرار في كل شيء، من الذرة إلى المجرة. 🌌
    </p>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    with st.expander("🔆 النورانية (14)", expanded=False):
        light_vals = {}
        for L, D in MIZAN_LETTERS["light"].items():
            light_vals[L] = st.slider(f"{L} ({D['l']})", 0.0, 1.0, 0.7, 0.01, help=D['a'])
    with st.expander("⚙️ المحايدة (6)", expanded=False):
        neutral_vals = {}
        for L, D in MIZAN_LETTERS["neutral"].items():
            neutral_vals[L] = st.slider(f"{L} ({D['l']})", 0.0, 1.0, 0.5, 0.01, help=D['a'])
    with st.expander("🌑 الظلامية (8)", expanded=False):
        dark_vals = {}
        for L, D in MIZAN_LETTERS["dark"].items():
            dark_vals[L] = st.slider(f"{L} ({D['l']})", 0.0, 1.0, 0.2, 0.01, help=D['a'])
...
def calc_S(W, B, E, prayer, zakat, fasting, hajj, amr, nahy, adl, shura, light_vals, dark_vals):
    ق = light_vals.get('ق', 0.7) * 100
    ن = light_vals.get('ن', 0.7) * 50
    ص = light_vals.get('ص', 0.7) * 90
    ط = light_vals.get('ط', 0.7) * 9
    ح = light_vals.get('ح', 0.7) * 8
    أ = light_vals.get('أ', 0.7) * 1
    ل = light_vals.get('ل', 0.7) * 30
    م = light_vals.get('م', 0.7) * 40
    ر = light_vals.get('ر', 0.7) * 200
    ي = light_vals.get('ي', 0.7) * 10
    ع = light_vals.get('ع', 0.7) * 70
    س = light_vals.get('س', 0.7) * 60
...
def create_heatmap(sw, sb):
    ...
    wr = np.linspace(0, 1, 30); br = np.linspace(0, 1, 30)
    ...
    ax.set_xlabel('W', color='white', fontsize=10); ax.set_ylabel('B', color='white', fontsize=10)
    ax.set_title('S = W × B', color='white', fontsize=12, fontweight='bold')
    ax.tick_params(colors='white', labelsize=8); ax.set_xlim(0, 1); ax.set_ylim(0, 1)
...
if st.session_state.get("run", False):
    ...
    while st.session_state.get("run", False):
        try:
            ...
            eb.append(S)
            eff = int(delay_frames * (1 + dark_vals.get('غ', 0.2) * 0.5))
            eb_list = list(eb)
...
st.markdown("---")
st.markdown("<p style='text-align:center;color:gray;'>© 2026 علي عادل العاطفي | v9.0 القانون الأعظم</p>", unsafe_allow_html=True)
