...
if st.session_state.get("run", False):
    ...
    ax.scatter(st.session_state.sx,st.session_state.sy,s=45,c=colors,alpha=0.9,edgecolors='white',linewidth=0.3)
...
st.markdown("---")
st.markdown("<p style='text-align:center;color:gray;font-size:0.65em;'>© 2026 علي عادل العاطفي | v16</p>", unsafe_allow_html=True)
