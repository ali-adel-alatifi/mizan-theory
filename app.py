...
if module == "🏠 القمرة الرئيسية":
    ...
    **B** = البراءة من الطاغوت (الجهاد والعفة والاستقلال).
    ...
    st.pyplot(fig)
    # =============================================
# الوحدة 1: المستشار الشامل (GPT4All – يعمل محليًا)
# =============================================
elif module == "🧠 المستشار الشامل":
    st.header("🧠 المستشار الشامل – خبير في كل شيء")
    st.markdown("اسأل أي سؤال في أي مجال، وستحصل على إجابة من نموذج ذكاء اصطناعي حقيقي يعمل على جهازك.")

    # استيراد المكتبة (لن يتم تحميلها إلا عند الحاجة)
    from gpt4all import GPT4All

    # تحميل النموذج (مرة واحدة فقط)
    @st.cache_resource
    def load_model():
        with st.spinner("🧠 جاري تحميل العقل الشامل... (يستغرق دقائق في أول تشغيل، وحوالي 4 جيجابايت من المساحة)"):
            # "orca-mini-3b-gguf2-q4_0.gguf" هو نموذج صغير نسبيًا وسريع
    ...
    if model:
        ...
        if user_q:
            with st.spinner("🧠 العقل الشامل يفكر..."):
                # بناء "سياق" ذكي يوجه النموذج ليكون "مستشارًا" بنظرية الميزان
                system_prompt = (
        ...
        st.warning("⚠️ النموذج غير متاح. تأكد من تشغيل: pip install gpt4all")
# =============================================
